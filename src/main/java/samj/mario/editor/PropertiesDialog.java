...
import samj.mario.editor.command.ChangeLevelPropertiesCommand;
...
public class PropertiesDialog extends JDialog {
    ...
    private final JColorChooser backgroundColorChooser = new JColorChooser();
    ...
    public PropertiesDialog(LevelEditor levelEditor) {
        ...
        levelNameTextField.setText(levelEditor.getLevel().getName());
        timeLimitSpinner.setValue(levelEditor.getLevel().getTimeLimit());
        backgroundColorChooser.setColor(levelEditor.getLevel().getBackgroundColor());
    ...
    private void onOK() {
        ...
        String oldName = levelEditor.getLevel().getName();
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.add(widthSpinner, new GridConstraints(0, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel3.add(heightSpinner, new GridConstraints(1, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel3.add(levelNameTextField, new GridConstraints(2, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        timeLimitSpinner = new JSpinner();
        panel3.add(timeLimitSpinner, new GridConstraints(3, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel3.add(colorPreviewPanel, new GridConstraints(4, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
    }
    ...
    private void createUIComponents() {
        ...
        colorPreviewPanel.add(backgroundColorChooser);
    }
}
